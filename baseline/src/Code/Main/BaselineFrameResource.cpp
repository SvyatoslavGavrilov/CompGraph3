...
BaselineFrameResource::BaselineFrameResource(ID3D12Device* device, UINT passCount, UINT objectCount, UINT materialCount, UINT lightCount)
{
...
BaselineFrameResource::~BaselineFrameResource()
{
