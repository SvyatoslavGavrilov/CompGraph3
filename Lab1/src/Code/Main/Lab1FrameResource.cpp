...
Lab1FrameResource::Lab1FrameResource(ID3D12Device* device, UINT passCount, UINT objectCount, UINT materialCount, UINT lightCount)
{
...
Lab1FrameResource::~Lab1FrameResource()
{
