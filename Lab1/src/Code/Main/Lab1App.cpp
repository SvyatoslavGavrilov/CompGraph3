...
void Lab1App::DeferredDraw(const GameTimer&)
{
...
void Lab1App::Draw(const GameTimer&)
{
    // The Lab1 app renders via DeferredDraw.
}
...
void Lab1App::OnMouseUp(WPARAM, int, int)
{
    ReleaseCapture();
}
...
void Lab1App::OnKeyPressed(const GameTimer&, WPARAM key)
{
...
void Lab1App::OnKeyReleased(const GameTimer&, WPARAM)
{
}
...
void Lab1App::UpdateObjectCBs(const GameTimer&)
{
