...
// for a frame.  
struct Lab1FrameResource
{
public:
    
    Lab1FrameResource(ID3D12Device* device, UINT passCount, UINT objectCount, UINT materialCount,UINT lightCount);
    Lab1FrameResource(const Lab1FrameResource& rhs) = delete;
    Lab1FrameResource& operator=(const Lab1FrameResource& rhs) = delete;
    ~Lab1FrameResource();
