...
public:
    ...
    Labor4FrameResource(ID3D12Device* device, UINT passCount, UINT objectCount);
    Labor4FrameResource(const Labor4FrameResource& rhs) = delete;
    Labor4FrameResource& operator=(const Labor4FrameResource& rhs) = delete;
    ~Labor4FrameResource();
