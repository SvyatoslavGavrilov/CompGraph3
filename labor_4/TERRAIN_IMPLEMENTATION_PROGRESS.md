...
## File Locations:
- Main implementation: `labor_4/src/Baseline.cpp`
- Frame resources: `labor_4/src/BaselineFrameResource.h`
- Textures: `labor_4/src/Textures/terrain/ter_highmap.dds` and `ter_texture.dds`

## Notes:
- All classes are nested inside BaselineApp class as required
- Texture paths adapted for labor_4 structure
