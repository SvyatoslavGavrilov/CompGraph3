...
// for a frame.  
struct Labor1FrameResource
{
public:
    
    Labor1FrameResource(ID3D12Device* device, UINT passCount, UINT objectCount);
    Labor1FrameResource(const Labor1FrameResource& rhs) = delete;
    Labor1FrameResource& operator=(const Labor1FrameResource& rhs) = delete;
    ~Labor1FrameResource();
