//***************************************************************************************
// Simplified Labor1App - Rotating Rainbow Cube with Camera Controls
//***************************************************************************************
#include "d3dApp.h"
...
#include <array>
#include <string>
#include "labor_1FrameResource.h"
...
class Labor1App : public D3DApp
{
public:
    Labor1App(HINSTANCE hInstance);
    Labor1App(const Labor1App& rhs) = delete;
    Labor1App& operator=(const Labor1App& rhs) = delete;
    ~Labor1App();
...
private:
    std::vector<std::unique_ptr<Labor1FrameResource>> mFrameResources;
    Labor1FrameResource* mCurrFrameResource = nullptr;
...
Labor1App::Labor1App(HINSTANCE hInstance)
    : D3DApp(hInstance)
{
}
...
void Labor1App::Update(const GameTimer& gt)
{
...
void Labor1App::Draw(const GameTimer& gt)
{
...
void Labor1App::BuildRootSignature()
{
...
void Labor1App::BuildShadersAndInputLayout()
{
...
void Labor1App::BuildTerrainShaders()
{
...
void Labor1App::BuildCubeGeometry()
{
...
void Labor1App::BuildTerrainPSO()
{
...
void Labor1App::BuildFrameResources()
{
    for(int i = 0; i < gNumFrameResources; ++i)
    {
        mFrameResources.push_back(std::make_unique<Labor1FrameResource>(md3dDevice.Get(),
            1, 1));
    }
}

void Labor1App::BuildRenderItems()
{
...
void Labor1App::UpdateObjectCBs(const GameTimer& gt)
{
...
void Labor1App::UpdatePassCB(const GameTimer& gt)
{
...
void Labor1App::DrawRenderItems(ID3D12GraphicsCommandList* cmdList)
{
...
void Labor1App::CreateSrvDescriptorHeap()
{
...
bool Labor1App::LoadTerrainTexture(const std::wstring& texturePath)
{
...
bool Labor1App::LoadHeightmapFromFile(const std::wstring& heightmapPath)
{
...
UINT Labor1App::CalculateMaxLODLevels()
{
...
void Labor1App::BuildQuadtreeRecursive(QuadtreeNode* node, UINT maxLevels)
{
...
void Labor1App::CreateTerrainTile(QuadtreeNode* node)
{
...
void Labor1App::CalculateScreenSpaceError(QuadtreeNode* node)
{
...
void Labor1App::CreateSkirtGeometry(QuadtreeNode* node, UINT verticesPerSide, float tileWorldSize)
{
...
void Labor1App::ResetRenderFlags(QuadtreeNode* node)
{
    if (!node) return;
...
void Labor1App::SelectLODLevels()
{
...
void Labor1App::SelectLODRecursive(QuadtreeNode* node, bool parentVisible)
{
    if (!node)
        return;
...
bool Labor1App::IsNodeVisible(const QuadtreeNode* node) const
{
    if (!node)
        return false;
...
void Labor1App::RenderQuadtreeNodes(ID3D12GraphicsCommandList* cmdList, QuadtreeNode* node)
{
...
void Labor1App::OnMouseDown(WPARAM btnState, int x, int y)
{
...
void Labor1App::OnMouseUp(WPARAM btnState, int x, int y)
{
    ReleaseCapture();
    mRightMouseDown = false;
}

void Labor1App::OnMouseMove(WPARAM btnState, int x, int y)
{
    if(mRightMouseDown)
    {
...
void Labor1App::OnKeyPressed(const GameTimer& gt, WPARAM key)
{
